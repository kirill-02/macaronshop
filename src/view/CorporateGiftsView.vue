    ...
    <div class="container">
      <div class="corporate-gifts__wrapper">
        ...
        <div class="corporate-gifts__wrapper__sets">
          <div class="corporate-gifts__wrapper__sets_title">Наборы для свадьбы</div>
          ...
          <div class="corporate-gifts__wrapper__sets__cards">
            <app-sets-card
                ...
                :key="popularSet.id"
                :id="popularSet.id"
                :img="require(`@/../public/img/corporateGifts/2/${popularSet.img}`)"
        ...
        <div class="corporate-gifts__wrapper__completed-orders">
          ...
          <div class="corporate-gifts__wrapper__completed-orders__cards">
            ...
            <div class="corporate-gifts__wrapper__completed-orders__cards_card">
              <div class="corporate-gifts__wrapper__completed-orders__cards_card_img"><img src="" alt="">
              </div>
              <div class="corporate-gifts__wrapper__completed-orders__cards_card_description">Макароны для отеля “Бла бла”</div>
            </div>

            <div class="corporate-gifts__wrapper__completed-orders__cards_card">
              <div class="corporate-gifts__wrapper__completed-orders__cards_card_img"><img src="" alt="">
              </div>
              <div class="corporate-gifts__wrapper__completed-orders__cards_card_description">Набор для кафе “Мята””</div>
            </div>
